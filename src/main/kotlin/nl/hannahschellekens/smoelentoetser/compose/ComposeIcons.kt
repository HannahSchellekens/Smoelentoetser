...
object ComposeIcons {
    ...
    val fileImport: ImageVector
        get() {
            if (_TablerFileImport != null) return _TablerFileImport!!

            _TablerFileImport = ImageVector.Builder(
                name = "file-import",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
                viewportWidth = 24f,
            ...
            return _TablerFileImport!!
        }

    private var _TablerFileImport: ImageVector? = null
}